...
def print_welcome_message():
    print(Fore.GREEN + Style.BRIGHT + """
     YESCOIN AUTO TASK AND PLAY GAME BOT BY INSTANT EARNING
                
     Airdrop channel : https://t.me/InstantEarning169
...
def get_invitation(token):
    ...
    try:
        ...
        data = response.json()
        if data['code'] == 0:
            print(f"{Fore.BLUE + Style.BRIGHT} \n -\{Fore.WHITE + Style.BRIGHT} Invited by Instant Earning {Fore.BLUE + Style.BRIGHT}/-", flush=True)
